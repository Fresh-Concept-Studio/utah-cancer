...
- The current UCS Provo page confirms that **Provo Clinic** is at Utah Valley Hospital, Sorenson Legacy Tower, Building 4, 395 W. Cougar Blvd., Suite 104, Provo, UT 84604. The duplicate provider cards were consolidated into one Provo Clinic card with the confirmed address, directions, and **385.375.2700** phone number.
